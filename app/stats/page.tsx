...
async function getStats() {
  ...
  for (let i = 0; i < v.length; i++) {
    ...
    // handle multiple joined restaurants or single depending on type returned by supabase
    const r = Array.isArray(x.restaurant) ? x.restaurant[0] : x.restaurant
    const c = r?.cuisine_type ?? 'Outra'
